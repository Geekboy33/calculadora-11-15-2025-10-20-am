...
curl -X GET \\
  'https://api.luxliqdaes.cloud/api/v1/proof-of-reserves/${apiKey}' \\
...
`;
    ...
    txtLink.href = txtUrl;
    txtLink.download = `DAES_API_Credentials_${apiKey}_${new Date().toISOString().split('T')[0]}.txt`;
    document.body.appendChild(txtLink);
    txtLink.click();
    document.body.removeChild(txtLink);
    URL.revokeObjectURL(txtUrl);
    
    console.log('[PoR API] 📄 TXT de credenciales descargado automáticamente');
