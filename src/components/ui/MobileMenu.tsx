      ...
      >
        ...
        <div className="p-6 border-b border-[#1a1a1a] bg-gradient-to-r from-[#0d0d0d] to-[#0a0a0a]">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-[#ffffff] mb-1">Navigation</h2>
              <p className="text-xs text-[#ffffff]">DAES CoreBanking System</p>
            </div>
            <button
              onClick={onClose}
              className="p-2 hover:bg-[#1a1a1a] rounded-lg transition-colors"
            >
              <X className="w-6 h-6 text-[#ffffff] hover:text-[#ffffff]" />
            </button>
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? 'bg-[#ffffff]/20 text-[#ffffff] border border-[#ffffff] shadow-[0_0_15px_rgba(255, 255, 255,0.3)]'
                      : 'text-[#ffffff] hover:bg-[#1a1a1a] hover:text-[#ffffff] border border-transparent'
                  }
                `}
              >
                ...
                {isActive && (
                  <div className="ml-auto w-2 h-2 rounded-full bg-[#ffffff] pulse-green" />
                )}
              </button>
            );
          })}
