...
export function TransactionEventsModule() {
  ...
  const getTypeColor = (type: TransactionType): string => {
    if (type.includes('CREATED')) return 'text-white bg-white/20';
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={downloadCSV}
              className="px-4 py-2 bg-white/20 border border-white/30 text-white rounded-lg hover:bg-white/30 flex items-center gap-2"
            >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        {event.amount && event.amount > 0 && (
                          <span className="px-3 py-1 bg-white/20 text-white rounded text-xs font-bold flex items-center gap-1">
