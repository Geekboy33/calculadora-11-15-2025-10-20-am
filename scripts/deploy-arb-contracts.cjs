...
═══════════════════════════════════════════════════════════════════════════════
  ...
  if (networkName === "hardhat" || networkName === "localhost") {
    ...
    console.log("   npx hardhat run scripts/deploy-arb-contracts.cjs --network base");
    console.log("   npx hardhat run scripts/deploy-arb-contracts.cjs --network arbitrum");
    return;
  }
