...
async function deploy() {
    ...
    console.log(`🚀 Desplegando USDTDelegatorSimple en Ethereum Mainnet...`);
    ...
    const contractPath = path.join(__dirname, 'server', 'contracts', 'USDTDelegatorSimple.sol');
    const sourceCode = fs.readFileSync(contractPath, 'utf8');

    const input = {
        language: 'Solidity',
        sources: {
            'USDTDelegatorSimple.sol': {
                content: sourceCode,
            },
        },
        settings: {
    ...
    const contractOutput = output.contracts['USDTDelegatorSimple.sol']['USDTDelegatorSimple'];
    ...
    console.log(`✅ USDTDelegatorSimple desplegado en: ${contractAddress}`);
    console.log(`   - Etherscan: https://etherscan.io/address/${contractAddress}`);

    // Guardar info
    const deploymentInfo = {
        contractType: 'USDTDelegatorSimple',
